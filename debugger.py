...
#GRANT TODO: NOTE! Comment out ALL the bad stuff
audioPlan = [
    # Hi to humans
   ...
   # {'Antagonist': {'Antagoniststart':{1:None}},
   #  'Alpha': {'Alphastart':{1:None}},
   #  'Intellectual':  {'Intellectualstart':{1:None}},
   #  'Cancerfriend': {'Cancerfriendstart':{1:None}},
   #  'Redhead': {'Redheadstart':{1:None}},
   #  'Megatroll':   {'Megatrollstart':{1:None}},
   #  'Audience': {'Audiencestart':None},
   # },
    {'Antagonist': {'TestAudience01':None},
     'Alpha': {'Alpha01':None},
     'Intellectual':  {'Intellectual01':None},
     'Cancerfriend': {'Cancerfriend01':None},
     'Redhead': {'Redhead01':None},
     'Megatroll':   {'Megatroll01':None},
     'Audience': {'TestAudience01':None},
    },
    {'Antagonist': {'TestAudience02':None},
     'Alpha': {'Alpha02':None},
    ...
    {'Antagonist': {'TestAudience03':None},
     'Alpha': {'Alpha03':None},
